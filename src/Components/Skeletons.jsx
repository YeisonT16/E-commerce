...
function Skeletons() {
    ...
    return(               
                    ...
                    <figure className="relative mb-2 w-full h-4/5">
                        ...
                        <span className={`absolute top-0 right-0 flex justify-center items-center size-6 rounded-full m-2 p-1 ${styleBaground}`}></span>
                    </figure>
                    <span className={`px-2 h-5 rounded-lg block ${styleBaground}`}></span>
                    <p className="flex  justify-between items-center px-1">
                        <span className={`h-4 w-20 rounded-lg ${styleBaground}`}></span>
                        <span className={`h-4 w-20 rounded-lg ${styleBaground}`}></span>
                    </p>            
                    </div> 
        )
