        ...
        <div className="flex justify-between items-center border border-sky-500 w-80 rounded-lg p-4 mb-4">
            <p className="flex justify-between w-full">
                ...
                <p className="flex items-center gap-2">
                    ...
                    <button className="flex items-center text-white bg-transparent hover:border-l-gray-900 size-6 hover:border rounded-md  hover:text-blue-400 transition-transform hover:scale-125">
